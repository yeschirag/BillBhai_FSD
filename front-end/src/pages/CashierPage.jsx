...
function CashierPage() {
  ...
  const [holdsOpen, setHoldsOpen cart] = useState(false)
          ...
          <div className="step-container">
            <div className="wizard-centered success-block">
              ...
              {result.stage !== 'complete' ? (
                <p className="form-error">Payment could not be recorded. The order {result.order.id} exists — retry from Orders → Payments.</p>
                <p className="form-error">Payment could not be recorded. Order {result.order.id} exists — settle it from the Orders page.</p>
              ) : null}
